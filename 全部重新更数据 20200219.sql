...
truncate table [NaturalTraffic]
truncate table [NaturalTrafficImport]
truncate table [CPCCPMSummary]
truncate table [OrderPromotion]

truncate table [report].[ResultTimeDivisionSales]
truncate table [report].[ResultTimeDivisionSalesProportion]
truncate table [report].ResultDailySales
truncate table [report].[ResultNaturalTraffic]
truncate table [report].[ResultNaturalTrafficImport]
truncate table [report].[ResultCPCCPMSummary]
truncate table [report].[ResultDeliveryOrderPromotion]
go
...
where [CalculateType]='加总' and cityid='-1' 
go
...
on a.ChannelName=b.ChannelName and a.CityName=b.Market and a.Date=b.OrderDate
where [CalculateType]='单店日均' and cityid='-1' 
go
...
where [CalculateType]='加总' and cityid='0' 
go
...
on a.ChannelName=b.ChannelName and a.Date=b.OrderDate
where [CalculateType]='单店日均' and cityid='0' 
go
...
on a.cityname=b.cityname and a.Date=b.OrderDate
where [CalculateType]='单店日均' and [ChannelName]='total' 
go
