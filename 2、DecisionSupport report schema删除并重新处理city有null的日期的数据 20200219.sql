...
-----先删除更新storelist前对应dbo表中有cityname为null的日期的数据

/****** 订单数据结果表 ***********************/
----truncate table  [MCDDecisionSupport].[report].[ResultTimeDivisionSales]
delete from [MCDDecisionSupport].[report].[ResultTimeDivisionSales]
where [Date] in (select dataperiod from [MCDDecisionSupport].[dbo].[Ordertempdate])
go
...
where convert(varchar(10),下单时间,23) in (select dataperiod from [MCDDecisionSupport].[dbo].[Ordertempdate])
...
and a.[Date] in (select dataperiod from [MCDDecisionSupport].[dbo].[Ordertempdate])
go
...
and [Date] in (select dataperiod from [MCDDecisionSupport].[dbo].[Ordertempdate])
...
delete from [MCDDecisionSupport].[Report].[ResultTimeDivisionSalesProportion]
where [Date] in (select dataperiod from [MCDDecisionSupport].[dbo].[Ordertempdate])
go
...
-------------- 1) CITY LEVEL
------------------ tye=加总 
--truncate table [MCDDecisionSupport].report.ResultDailySales
delete from [MCDDecisionSupport].report.ResultDailySales
where [Date] in(select dataperiod from [MCDDecisionSupport].[dbo].[SalesSummarytempdate])
go
...
where 日期 in(select dataperiod from [MCDDecisionSupport].[dbo].[SalesSummarytempdate])
...
and date in(select dataperiod from [MCDDecisionSupport].[dbo].[SalesSummarytempdate])
...
/******** 自然流量结果表 *************/
delete from [Report].[ResultNaturalTraffic] 
where DataPeriod in (select DataPeriod from [MCDDecisionSupport].[dbo].[NaturalTraffictempdate])
go
...
where CalculateType='加总'
and DataPeriod in (select DataPeriod from [MCDDecisionSupport].[dbo].[NaturalTraffictempdate])
...
/********** 自然流量入口结果表 *************/
delete from [Report].[ResultNaturalTrafficImport] 
where DataPeriod in (select DataPeriod from [MCDDecisionSupport].[dbo].[NaturalTrafficImporttempdate])
go
...
/*********** 推广数据结果表 ***************/
delete from [Report].[ResultCPCCPMSummary] 
where DataPeriod in (select DataPeriod from [MCDDecisionSupport].[dbo].[CPCCPMSummarytempdate])
go

------------1. channel=eleme/meituan
-------------- 1) CITY LEVEL
------------------ tye=加总 
----delete from [Report].[ResultCPCCPMSummary]  where DataPeriod='2019-05-20'
...
(
	...
	and DataPeriod in (select DataPeriod from [MCDDecisionSupport].[dbo].[CPCCPMSummarytempdate])
...
/********* 促销活动订单占比结果表 ***********/
delete from [Report].[ResultDeliveryOrderPromotion]
where [Date] in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
where convert(varchar(10),下单时间,23) in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
...
where [CalculateType]='加总' and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
on a.ChannelName=b.ChannelName and a.CityName=b.cityname and a.Date=b.OrderDate
where [CalculateType]='单店日均' and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
where [CalculateType]='加总' and cityid='-1' and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
on a.ChannelName=b.ChannelName and a.CityName=b.Market and a.Date=b.OrderDate
where [CalculateType]='单店日均' and cityid='-1' and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
where [CalculateType]='加总' and cityid='0' and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
on a.ChannelName=b.ChannelName and a.Date=b.OrderDate
where [CalculateType]='单店日均' and cityid='0' and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
where [CalculateType]='加总' and [ChannelName]='total' and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
...
on a.cityname=b.cityname and a.Date=b.OrderDate
where [CalculateType]='单店日均' and [ChannelName]='total' and date in (select DataPeriod from [MCDDecisionSupport].[dbo].[OrderPromotiontempdate])
go
