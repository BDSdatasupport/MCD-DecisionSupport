...
delete from [Order] where convert(varchar(10),下单时间,23) > ''
delete from [SalesSummary] where 日期 > ''
delete from [NaturalTraffic] where [DataPeriod] > ''
delete from [NaturalTrafficImport] where [DataPeriod] > ''
delete from [CPCCPMSummary] where [DataPeriod] > '' --跟[NaturalTraffic]、[SalesSummary]也有关，即这两张表任意一张有某天改动，cpccpm也要重新计算
delete from [OrderPromotion] where convert(varchar(10),下单时间,23) > '' --跟[Order]有关


delete from [report].[ResultTimeDivisionSales] where [Date] > '' --跟[Order]有关
delete from [report].[ResultTimeDivisionSalesProportion] where [Date] > ''   --跟[ResultTimeDivisionSales]有关
delete from [report].ResultDailySales where [Date] > '' --跟[SalesSummary]有关
delete from [report].[ResultNaturalTraffic] where DataPeriod > '' --跟[NaturalTraffic]有关
delete from [report].[ResultNaturalTrafficImport] where DataPeriod > '' --跟[NaturalTrafficImport]有关
delete from [report].[ResultCPCCPMSummary] where DataPeriod > '' --跟[CPCCPMSummary]有关
delete from [report].[ResultDeliveryOrderPromotion] where [Date] > ''--跟[OrderPromotion]有关
go
...
where convert(varchar(10),下单时间,23) > ''
order by 下单时间
go
...
WHERE a.rn = 1
and convert(date,create_time-1)  > ''
GO
...
where [CalculateType]='加总' and date  > ''
go
...
on a.ChannelName=b.ChannelName and a.CityName=b.cityname and a.Date=b.OrderDate
where [CalculateType]='单店日均' and date  > ''
go
...
where [CalculateType]='加总' and cityid='-1' and date  > ''
go
...
on a.ChannelName=b.ChannelName and a.CityName=b.Market and a.Date=b.OrderDate
where [CalculateType]='单店日均' and cityid='-1' and date  > ''
go
...
where [CalculateType]='加总' and cityid='0' and date  > ''
go
...
on a.ChannelName=b.ChannelName and a.Date=b.OrderDate
where [CalculateType]='单店日均' and cityid='0' and date  > ''
go
...
where [CalculateType]='加总' and [ChannelName]='total' and date  > ''
go
...
on a.cityname=b.cityname and a.Date=b.OrderDate
where [CalculateType]='单店日均' and [ChannelName]='total' and date  > ''
go
